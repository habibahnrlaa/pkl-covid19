      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="login100-more" style="background-image: url('frontend/img/bg1.jpeg');">
						<div class="col-md-12 col-md-offset-0 text-center js-fullheight slider-text">
					<div class="slider-text-inner">
					<h1><strong>Hidup hanya sekali,</strong></h1>
					<h1><strong>Hiduplah yang berarti.</strong></h1>
				</div>
              <div class="col-lg-12">
                <div class="p-5">
